...
var open_notify = false;

function notifycation(){
  var ntext = document.getElementById("notify_pc_text");
  
  if(open_notify){
    ntext.textContent = "Уведомления";
    open_notify = false;
    document.getElementById("notify").style.display = "none";
  }else{
    ntext.textContent = "Закрыть";
    open_notify = true;
...
function clears_notifi(){
  ...
  texts.style = "color: #db6724; cursor: default; display: block; justify-content: center; text-align: center; margin: 60px;";
